...
const AutoScroll = forwardRef(({ children, speed = "medium", hover = "slow", reverse = false, className, style, scrollGap, ...flex }, ref) => {
    ...
    return (_jsx(Row, { overflow: "hidden", fillWidth: true, ref: ref, className: className, style: style, ...flex, children: _jsxs(Row, { fillWidth: true, ref: wrapperRef, className: styles.marqueeWrapper, onMouseEnter: () => setIsHovering(true), onMouseLeave: () => setIsHovering(false), children: [_jsx(Row, { fitWidth: true, horizontal: "around", className: styles.marqueeContent, ref: contentRef, style: { marginRight: gapStyle }, children: children || childrenStable }), _jsx(Row, { fitWidth: true, horizontal: "around", className: styles.marqueeContent, style: { marginRight: gapStyle }, children: children || childrenStable })] }) }));
});
